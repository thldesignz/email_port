...
const PortfolioLanding = () => {
    let title = 'About Me',
        description = 'I am a HTML Email Developer/ Front End Web Developer. I have a passion for creating and I enjoy building beautiful responsive emails and websites.';
    const PostList = BlogContent.slice(0 , 3);
    return (
        <div className="active-dark bg_color--9">
            <Helmet pageTitle="My Portfolio" />
                            ...
                            <div className="row row--35">
                                <div className="col-lg-5">
                                    <div className="thumbnail">
                                        <img className="w-100" src="/assets/images/about/twitt.jpg" alt="About Images"/>
                                    </div>
                                </div>
